...
export default function Header() {
  ...
  const networks = ["Ethereum Mainnet", "BNB Smart Chain", "Polygon (MATIC)"];
  ...
  const vipTiers = [
    ...
    // { id: "enterprise", name: "Enterprise - Custom", price: Infinity },
  ];
  ...
  return (
    <header className="w-full bg-gradient-to-r from-[#1e293b] to-[#0F123D] bg-opacity-80 text-white shadow-md">
      ...
      {showVipModal && (
        <div className="fixed inset-0 bg-[#0F123D] bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-gray-700 rounded-lg p-6 w-96 relative flex">
            <button
            ...
            <div className="w-full pr-4">
              ...
              <div className="space-y-3">
                {vipTiers.map((tier) => (
                  <div
                    key={tier.id}
                    className={`flex items-center gap-2 border rounded-lg p-2 w-full ${
              ...
              <div className="mt-2 border border-blue-400 py-1 rounded text-blue-200 flex items-center gap-2">
              <FaTelegram className="ml-2 text-blue-400 size-6" />
              Enterprise - Custom
            </div>  
            <button
